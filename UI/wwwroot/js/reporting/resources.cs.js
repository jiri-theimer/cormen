(function (trv, $) {
    ...
    var sr = {
        ...
        loadingReportPagesInProgress: '{0} stránek zatím nahráno...',
        loadedReportPagesComplete: 'Hotovo. Celkem nahráno stránek: {0}.',
        noPageToDisplay: "Ani jedna stránka k zobrazení.",
        ...
        menuZoomInTitle: 'Zvětšit (přiblížit)',
        menuZoomOutTitle: 'Zmenšit (oddálit)',
        ...
        menuPrintPreviewText: 'Přepnout na náhled k tisku',
        menuPrintPreviewTitle: 'Přepnout na náhled k tisku',
        menuSearchText: 'Najít',
        menuSearchTitle: 'Přepnout na [Najít]',
        ...
        ariaLabelPageNumberSelector: "Vybrat číslo stránky. Zobrazit stránku {0} z {1}.",
        ...
        ariaLabelMenuFirstPage: 'První stránka',
        ariaLabelMenuLastPage: 'Poslední stránka',
        ariaLabelMenuPreviousPage: 'Předchozí stránka',
        ariaLabelMenuNextPage: 'Další stránka',
        ariaLabelMenuPageNumber: 'Výběr čísla stránky',
        ...
        searchDialogResultsFormatLabel: "Výsledek {0} z {1}",
