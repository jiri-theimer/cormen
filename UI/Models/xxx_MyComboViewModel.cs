...
namespace UI.Models
{
    public class xxx_MyComboViewModel
    {
        ...
        public xxx_MyComboViewModel(string strEntity,string strSelectedValue,string strSelectedText,string strControlID)
        {
