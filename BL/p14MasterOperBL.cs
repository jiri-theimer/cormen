...
namespace BL
{
    ...
    {       
        ...
        {
            return "SELECT a.*,p19.p19Code,p19.p19Name,p19.p19Code+' - '+p19.p19Name as Material,p18.p18Code as OperCode," + _db.GetSQL1_Ocas("p14") + " FROM "+ BL.TheEntities.ByPrefix("p14").SqlFrom;
        }
        public BO.p14MasterOper Load(int pid)
        {
