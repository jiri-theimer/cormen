...
namespace BL
{
    public class TheEntities
    {
        ...
        {           
            ...
            AE("p31CapacityFond", "Kapacitní fondy", "Kapacitní fond", "p31CapacityFond a INNER JOIN j02Person j02owner ON a.j02ID_Owner=j02owner.j02ID LEFT OUTER JOIN p28Company p28 ON j02owner.p28ID=p28.p28ID");
            ...
            AE("p12ClientTpv", "Klientské receptury", "Klientská receptura", "p12ClientTpv a INNER JOIN p21License p21 ON a.p21ID=p21.p21ID LEFT OUTER JOIN p28Company p28 ON p21.p28ID=p28.p28ID LEFT OUTER JOIN p13MasterTpv p13 ON a.p13ID_Master=p13.p13ID LEFT OUTER JOIN p25MszType p25 ON p13.p25ID=p25.p25ID");
